...
if __name__ == '__main__':
    ...
    query = f"hijab (muslim OR hijab OR headscarf OR woman OR islam) (#hijab OR #islam OR #muslim OR #woman OR #headscarf) lang:en until:{year}-{month}-28 since:{year}-{month}-01"
