...
if __name__ == '__main__':
    ...
    query = f"muslim (muslim OR muslimah OR muslimeen OR islam OR muslims OR moslem) (#muslims OR #muslim) lang:en until:{year}-{month}-28 since:{year}-{month}-01"
